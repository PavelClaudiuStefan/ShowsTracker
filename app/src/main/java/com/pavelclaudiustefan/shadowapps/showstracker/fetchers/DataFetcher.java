...
public abstract class DataFetcher {
    ...
    private final String LOG_TAG = "DataFetcher";

    public List<VideoMainItem> fetchData(String stringUrl) {
    ...
    public abstract List<VideoMainItem> extractItemsFromJson(String itemsJSON);
}
